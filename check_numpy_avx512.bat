...
for /f %%i in ('python -c "from numba.misc import numba_sysinfo; sysinfo=numba_sysinfo.get_sysinfo(); print(sysinfo[\"NumPy AVX512_SKX detected\"] and sysinfo[\"NumPy Version\"]>=\"1.22\")"') do set NUMPY_DETECTS_AVX512_SKX_NP_GT_122=%%i
